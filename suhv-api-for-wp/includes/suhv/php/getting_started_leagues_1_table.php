...
<div class="container">
  <div class="row">
    <h1>Where we retrieve all leagues for Saison</h1>
    ...
    <?php
      ...
      $details = $api->leagues(2016,array(
        'locale' => 'de'
      )); 
      ...
      echo "<thead><tr>".
           "<th>"."Liga"."</th><th>"."Liga-ID"."</th><th>"."Game-Class"."</th>". 
           "</tr></thead>";
      echo "<tbody>";
      $i = 0;
      ...
      do {
           $league_Name =  $entries[$i]->text;
           $league_ID =  $entries[$i]->set_in_context->league;
           $league_Class =  $entries[$i]->set_in_context->game_class;
          
           echo "<tr>".
           "<td>".$league_Name."</td><td>". $league_ID ."</td><td>".$league_Class."</td>". 
           "</tr>"; 
           $i++; 
